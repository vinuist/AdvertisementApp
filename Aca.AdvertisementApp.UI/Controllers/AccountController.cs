...
namespace Aca.AdvertisementApp.UI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IGenderService genderService, IValidator<UserCreateModel> userCreateValidator, IAppUserService appUserService, IMapper mapper, IValidator<AppUserLoginDto> loginDtoValidator)
        {
